...
public class Chapter01 extends Config{
...
*/	
	...
	public void testHelloWorld() {
		...
		long l = conn.setnx(key + "a", value);
		System.out.println("l = " + l);
		SetParams param = SetParams.setParams().ex(10).nx();
		String nx = conn.set(key + "nx", value, param);	
		System.out.println("nx = " + nx);
		
		System.out.println("conn get =" + conn.get(key));
		System.out.println("conn get =" + conn.getrange(key, 6, 20));
	}
	
	@Test
	public void testHelloWorldTime() {
		String key = "hello:a";
		String value = " world世界";
		Date begin = new Date();
...
//			System.out.println("testHelloWorldTime get = " + result);
		}
		Date end = new Date();
		System.out.println("花费时间:" + (end.getTime() - begin.getTime()));
